...
From the repository root:
    ...
    dotnet build .\MD.CMS.BusinessLogic.WebApi.Core\MD.CMS.BusinessLogic.WebApi.Core.csproj -c Debug

## Optional local run

If this project is an executable host, run:

    dotnet run --project .\MD.CMS.BusinessLogic.WebApi.Core\MD.CMS.BusinessLogic.WebApi.Core.csproj

Library projects should usually be consumed through a host project instead of running directly.

## Key files

- `MD.CMS.BusinessLogic.WebApi.Core\MD.CMS.BusinessLogic.WebApi.Core.csproj`
