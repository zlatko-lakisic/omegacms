...
# MD.CMS.Administration.Core.Hosted

**Hosted** ASP.NET Core site for the operator administration experience (IIS / Kestrel).

## Project metadata

- **Product** (`.csproj`): `OmegaCMS Hosted Administration`
...
From the repository root:
    ...
    dotnet build .\MD.CMS.Administration.Core.Hosted\MD.CMS.Administration.Core.Hosted.csproj -c Debug

## Optional local run

If this project is an executable host, run:

    dotnet run --project .\MD.CMS.Administration.Core.Hosted\MD.CMS.Administration.Core.Hosted.csproj
