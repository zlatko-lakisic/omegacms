...
# MD.CMS.BusinessLogic.Core.Tests
...
From the repository root:
    ...
    dotnet test .\MD.CMS.BusinessLogic.Core.Tests\MD.CMS.BusinessLogic.Core.Tests.csproj

**Target framework:** net10.0

## Key files

- `MD.CMS.BusinessLogic.Core.Tests\MD.CMS.BusinessLogic.Core.Tests.csproj`
