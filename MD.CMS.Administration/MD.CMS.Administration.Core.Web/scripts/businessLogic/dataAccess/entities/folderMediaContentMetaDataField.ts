...
namespace mdBusinessLogic.dataAccess.entities {
    export class folderMediaContentMetaDataField extends base.BaseEntity implements base.IBaseEntity<folderMediaContentMetaDataField> {
        ...
        public clone(): folderMediaContentMetaDataField {
