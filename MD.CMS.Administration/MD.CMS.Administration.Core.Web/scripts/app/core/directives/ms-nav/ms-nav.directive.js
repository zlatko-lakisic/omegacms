(function ()
{
    ...
    angular
        ...
        .directive('msNavIsFolded', ['$document', '$rootScope', 'msNavFoldService', msNavIsFoldedDirective])
        .controller('MsNavController', MsNavController)
        .directive('msNav', ['$rootScope', '$mdComponentRegistry', 'msNavFoldService', msNavDirective])
        .directive('msNavTitle', msNavTitleDirective)
        .directive('msNavButton', msNavButtonDirective)
        .directive('msNavToggle', ['$rootScope', '$q', '$animate', '$state', msNavToggleDirective]);
