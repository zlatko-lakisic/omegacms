(function ()
{
    ...
    angular
        .module('app.core')
        .directive('msMaterialColorPicker', ['$mdMenu', '$mdColorPalette', 'fuseGenerator', msMaterialColorPicker]);
    ...
    function msMaterialColorPicker($mdMenu, $mdColorPalette, fuseGenerator)
    {
        return {
            ...
            templateUrl: 'scripts/app/core/directives/ms-material-color-picker/ms-material-color-picker.html',
