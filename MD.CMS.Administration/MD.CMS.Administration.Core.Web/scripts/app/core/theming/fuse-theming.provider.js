(function ()
{
    ...
    angular
        .module('app.core')
        .provider('fuseTheming', ['mdSavedDataProvider', fuseThemingProvider]);

    /** @ngInject */
    function fuseThemingProvider(mdSavedDataService)
    {
        ...
        this.$get = function ()
        {
            ...
            function setActiveTheme(themeName)
            {
                ...
                if ( angular.isUndefined(service.themes.list[themeName]) )
                {
                    ...
                    mdSavedDataService.storeData('selectedTheme', service.themes.active.name, true);
                ...
                mdSavedDataService.storeData('selectedTheme', themeName, true);
            }
