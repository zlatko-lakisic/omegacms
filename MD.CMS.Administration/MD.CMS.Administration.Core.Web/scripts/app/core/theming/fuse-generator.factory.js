(function ()
{
    ...
    angular
        .module('app.core')
        .factory('fuseGenerator', ['mdSavedDataService', '$log', 'fuseTheming', fuseGeneratorService]);

    /** @ngInject */
    function fuseGeneratorService(mdSavedDataService, $log, fuseTheming)
    {
        ...
        function processAndStoreThemes(_themes)
        {
            ...
            var selectedTheme = mdSavedDataService.getData('selectedTheme');
