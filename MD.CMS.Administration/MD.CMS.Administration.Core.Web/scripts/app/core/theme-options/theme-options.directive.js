(function ()
{
    ...
    angular
        .module('app.core')
        .controller('MsThemeOptionsController', ['mdSavedDataService', 'fuseTheming', MsThemeOptionsController])
        .directive('msThemeOptions', msThemeOptions);

    /** @ngInject */
    function MsThemeOptionsController(mdSavedDataService, fuseTheming)
    {
        var vm = this;
        ...
        vm.layoutMode = 'wide';
        vm.layoutStyle = mdSavedDataService.getData('layoutStyle') || 'verticalNavigation';
        ...
        {
            // Update the cookie
            mdSavedDataService.storeData.put('layoutStyle', vm.layoutStyle, true);
    ...
    function msThemeOptions()
    {
        return {
            ...
            templateUrl: 'scripts/app/core/theme-options/theme-options.html',
