...
From the repository root:
    ...
    dotnet test .\MD.Tools.Helpers.Core.Tests\MD.Tools.Helpers.Core.Tests.csproj

**Target framework:** net10.0

## Key files

- `MD.Tools.Helpers.Core.Tests\MD.Tools.Helpers.Core.Tests.csproj`
