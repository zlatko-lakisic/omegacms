...
Execute unit tests
```
    cd "MD.CMS.Administration.Core.AwsLambda/test/MD.CMS.Administration.Core.AwsLambda.Tests"
    dotnet test
```

Deploy application
```
    cd "MD.CMS.Administration.Core.AwsLambda/src/MD.CMS.Administration.Core.AwsLambda"
