...
pipeline {
    ...
    stages {
        ...
        stage("Project & AWS Infrastructure Setup"){
            steps {
                parallel(
                    "Project Setup": {
                        script {
                ...
                script {
                    if (rollbackException == null) {
                        try {
                            dir(projectDirectory) {
                                ...
                                dir("MD.CMS.Administration.Core.AwsLambda") {
                                    ...
                                    def package_opts = [
                                        ...
                                        "packageFileName": omegaAdminStackName
                                    ]
                                    def packageName = cmsTools.packageDotnetLambda(package_opts)
                                ...
                                dir("MD.CMS.WebApi.Core.AwsLambda") {
                                    ...
                                    templateParameters = genericTools.appendObjectVariable(templateParameters, "MDCMSBusinessLogicCoreSessionDomain", "temp", true)
                                    ...
                                    templateParameters = genericTools.appendObjectVariable(templateParameters, "MDCMSWebApiCoreCorsOrigins", "[]", true)
                                ...
                                dir("MD.CMS.WebApi.Sockets.Core.AwsLambda") {
                                    ...
                                    templateParameters = genericTools.appendObjectVariable(templateParameters, "VpcSubnet1Id", subnet1VpcId, true)
                                    templateParameters = genericTools.appendObjectVariable(templateParameters, "VpcSubnet2Id", subnet2VpcId, true)
                                    templateParameters = genericTools.appendObjectVariable(templateParameters, "GatewayName", omegaWsSocketStackName, true)
                                    templateParameters = genericTools.appendObjectVariable(templateParameters, "MDCMSBusinessLogicCoreDefaultLcid", cms_lcid, true)
                                    if(cms_emailEnabled){
                                        templateParameters = genericTools.appendObjectVariable(templateParameters, "MDCMSBusinessLogicCoreEmailHost", cms_emailHost, true)
                                        templateParameters = genericTools.appendObjectVariable(templateParameters, "MDCMSBusinessLogicCoreEmailPort", cms_emailPort, true)
                            ...
                            println "Error occured during lambda instance deployment!"
                            rollbackRequired = true
                            rollbackException = e
                            println e.toString()
                        }
