...
# MD.CMS.Tools.BaseDataAccess.PluginMethods

CMS-specific **plugin methods** built on `MD.Tools.BaseDataAccess.PluginMethods.Core`.
...
From the repository root:
    ...
    dotnet build .\MD.CMS.Tools.BaseDataAccess.PluginMethods\MD.CMS.Tools.BaseDataAccess.PluginMethods.csproj -c Debug

## Optional local run

If this project is an executable host, run:

    dotnet run --project .\MD.CMS.Tools.BaseDataAccess.PluginMethods\MD.CMS.Tools.BaseDataAccess.PluginMethods.csproj

Library projects should usually be consumed through a host project instead of running directly.

## Key files

- `MD.CMS.Tools.BaseDataAccess.PluginMethods\MD.CMS.Tools.BaseDataAccess.PluginMethods.csproj`
