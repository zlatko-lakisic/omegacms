...
From the repository root:
    ...
    dotnet build .\MD.Tools.BaseDataAccess.Plugins.Core\MD.Tools.BaseDataAccess.Plugins.Core.csproj -c Debug

## Optional local run

If this project is an executable host, run:

    dotnet run --project .\MD.Tools.BaseDataAccess.Plugins.Core\MD.Tools.BaseDataAccess.Plugins.Core.csproj

Library projects should usually be consumed through a host project instead of running directly.

## Key files

- `MD.Tools.BaseDataAccess.Plugins.Core\MD.Tools.BaseDataAccess.Plugins.Core.csproj`
