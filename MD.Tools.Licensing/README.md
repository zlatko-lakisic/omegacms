...
From the repository root:
    ...
    dotnet build .\MD.Tools.Licensing\MD.Tools.Licensing.csproj -c Debug

## Optional local run

If this project is an executable host, run:

    dotnet run --project .\MD.Tools.Licensing\MD.Tools.Licensing.csproj

Library projects should usually be consumed through a host project instead of running directly.

## Key files

- `MD.Tools.Licensing\MD.Tools.Licensing.csproj`
