...
namespace MD.CMS.WebApi.Core.Hosted.BusinessLogic.Middleware
{
                ...
                if (socketObj != null) 
                {
                    ...
                    await Receive(threadSafeSocket, async (id, buffer, threadSafeSocket) =>
                    {
                        ...
                        catch (WebSocketException error)
                        {
                            ...
                            await threadSafeSocket.CloseAsync();
                            ThreadSafeSocket sock;
                            _manager.GetAllSockets().TryRemove(threadSafeSocket.Id, out sock);
                        }
