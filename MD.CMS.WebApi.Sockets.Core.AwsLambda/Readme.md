...
Execute unit tests
```
    cd "MD.CMS.WebApi.Sockets.Core.AwsLambda/test/MD.CMS.WebApi.Sockets.Core.AwsLambda.Tests"
    dotnet test
```

Deploy application
```
    cd "MD.CMS.WebApi.Sockets.Core.AwsLambda/src/MD.CMS.WebApi.Sockets.Core.AwsLambda"
